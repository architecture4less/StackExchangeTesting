...
public final class ResponsivenessTestCase {
    ...
    public static void homepageRenderTimeTest() {
        ...
        try {
            ...
            LoggerFactory.getLogger("smallFeedLayoutTest").info("loaded homepage in {}ms", actualMs);
            sleep(2.0);
    ...
    public static void smallFeedLayoutTest() {
        ...
        LoggerFactory.getLogger("smallFeedLayoutTest").info("browser: ({} x {})",
            browserSize.getWidth(), browserSize.getHeight());
        ...
        for (TestBrowser browser : TestBrowser.values()) {
            ...
            try {
                ...
                LoggerFactory.getLogger("smallFeedLayoutTest").info("{}, elem width: {}",
                    browser.name(), elemWidth);
            }
            finally {
                driver.quit();
            }
    ...
    public static void smallLoginModalTest() {
        ...
        LoggerFactory.getLogger("smallLoginModalTest").info("browser: ({} x {})",
            browserSize.getWidth(), browserSize.getHeight());
        ...
        for (TestBrowser browser : TestBrowser.values()) {
            ...
            try {
                ...
                sleep(2.0);
                {
                    ...
                    LoggerFactory.getLogger("smallLoginModalTest").info("{}, elem width: {}",
                        browser.name(), elemWidth);
                }
            }
            finally {
    ...
    public static void smallDropdownTest() {
        ...
        LoggerFactory.getLogger("smallDropdownTest").info("browser: ({} x {})",
            browserSize.getWidth(), browserSize.getHeight());
        ...
        for (TestBrowser browser : TestBrowser.values()) {
            ...
            try {
                ...
                LoggerFactory.getLogger("smallDropdownTest").info("{}, elem: ({} x {})",
                    browser.name(), elemSize.getWidth(), elemSize.getHeight());
            }
            finally {
                driver.quit();
            }
